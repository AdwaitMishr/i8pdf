...
| Signal | Count | Share |
| --- | ---: | ---: |
| Facts extracted | 4799 | 100% |
| Facts with no period attached | 2808 | 59% |
| Facts whose metric is a single word | 1086 | 23% |
| Facts in units that cannot be compared across documents | 2307 | 48% |
...
- No. of options for Delhivery in 2024-03-31 is reported as 9,686,124 by 02-delhivery-
  annual-report-fy24-excerpt p.97 and 10,190,000 by 02-delhivery-annual-report-fy24-excerpt
  p.98. No difference in period, basis, vintage or adjustment was found between the two
  statements, and the gap of 4.94% is larger than their stated precision allows.
